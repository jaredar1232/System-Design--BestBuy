...
xdescribe("Generator and Seed Performance", () => {
  test("generator timing has been recorded", async () => {
    const readTimeData = () => {
      return new Promise((resolve, reject) =>
        fs.readFile("TimingData/generateTiming.txt", (err, data) => {
          if (err) {
            reject(err);
          } else {
            resolve(data);
  ...
  test("import timing has been recorded", async () => {
    const readTimeData = () => {
      return new Promise((resolve, reject) =>
        fs.readFile("TimingData/importTiming.txt", (err, data) => {
          if (err) {
            reject(err);
          } else {
            resolve(data);
...
xdescribe("MongoDB Query Performance", () => {
  ...
  test("query in under 10 miliseconds", async () => {
    ...
    const readTimeData = () => {
      return new Promise((resolve, reject) =>
        fs.readFile("TimingData/searchStringTiming.txt", (err, data) => {
          if (err) {
            reject(err);
          } else {
            resolve(data);
  ...
  test("query the last 10% of DB in under 10 milliseconds", async () => {
    ...
    const readTimeData = () => {
      return new Promise((resolve, reject) =>
        fs.readFile("TimingData/searchIdTiming.txt", (err, data) => {
          if (err) {
            reject(err);
          } else {
            resolve(data);
